...
pub enum Instruction {
    ...
    RotateLeft(Operand8),
    RotateLeftThroughCarry(Operand8),
    RotateRight(Operand8),
    RotateRightThroughCarry(Operand8),
    ShiftLeftA(Operand8),
...
impl fmt::Display for Instruction {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match *self {
            ...
            RotateAccumulatorLeft => write!(f, "RLCA"),
            RotateAccumulatorLeftThroughCarry => write!(f, "RLA"),
            RotateAccumulatorRight => write!(f, "RRCA"),
            RotateAccumulatorRightThroughCarry => write!(f, "RRA"),
            ...
            RotateLeft(ref operand) => unary(f, "RLC", operand),
            RotateLeftThroughCarry(ref operand) => unary(f, "RL", operand),
            RotateRight(ref operand) => unary(f, "RRC", operand),
            RotateRightThroughCarry(ref operand) => unary(f, "RR", operand),
